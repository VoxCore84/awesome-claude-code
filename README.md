...
- [claude-code-scroll-fix](https://github.com/VoxCore84/claude-code-scroll-fix) - Stop Claude Code from hijacking your scroll position. Workarounds for the #1 terminal UX complaint — Windows Terminal fix, tmux isolation, WezTerm config, and automated installers.
